<template>
    <div class="login">
        <div class="box">
            <h2>Login</h2>
            <el-form ref="formRef" :model="validateForm" :rules="inputRules" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item>
                    ...
                    <el-button type="danger" link @click="goToRegisterPage">No account? Register now!</el-button>
                </el-form-item>
